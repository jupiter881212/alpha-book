  ...
  <div class="about-this-project css-1u90wth">
    <section class="Project-outline css-1wdiqs4">
      ...
      <div class="css-m6hssr">
        ...
        <p style="padding-bottom: 0.5em; border-bottom-color: rgb(172, 152, 122); border-bottom-width: 0.3em; border-bottom-style: solid;"><span style="font-family:Trebuchet MS,Helvetica,sans-serif;"><span style="font-size:24px;"><strong>取引一覧</strong></span><br>
        <span style="font-size:14px;">&nbsp;My bet</span></span></p>
        <br>
        <main id="main">
        <section class="history">
          <form action="my-page.php" id="UserBetIncompleteForm" method="post" accept-charset="utf-8" class="ng-pristine ng-valid">
            <div style="display:none;">
              ...
              <!-- <div class="history_main cf">
                ...
                <h1 class="CpPageTitle">取引一覧</h1>
                <div class="data">
                  <table>
                    <tr>
                      <th>取引<br class="min">日時</th>
                      <th>カテゴリー</th>
                      <th>ゲーム名</th>
                      <th>ベット情報</th>
                      <th>ステータス</th>
                      <th>取引<br class="min">金額</th>
                      <th>取引<br class="min">結果</th>
                      <th>払戻<br class="min">金額</th>
                    </tr>
                     <tr>
                      <td>2021/03/13</td>
                      <td>格闘技</td>
                ...
                <div class="signup-button-wrap">
                            <a href="my-page.php" style="text-decoration: none;"><button>
                                マイページ
                              </button></a>
                          </div>
              <!--  <a href="https://alpha-book.asia/my-page.php" class="css-11g9kr1 gogo top_ma_a">-->
